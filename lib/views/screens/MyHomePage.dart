                ...
                Expanded(
                  child: ListView(
                    ...
                    children: List.generate(
                      ...
                      (index) => InkWell(
                        onTap: (){
                          Get.toNamed("/DeatilesPage",arguments: [index]);
                        },
                        child: HoroscopItem(
                          titel: horoscopList[index]["titel"].toString(),
                          time: horoscopList[index]["time"].toString(),
                          imagePath: horoscopList[index]["img"].toString(),
                        ),
                      ),
                    ),
                  ),
